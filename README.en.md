...
5.  [src](src): source code;
    ...
    5.  [dump](src/dump): Crash capture function;
        ...
        2.  [crashpad](src/dump/crashpad.hpp): Crash capture based on Google Crashpad package;
            ...
            > 在unix系统下，可能需要对`crashpad_handler`Grant execution permission, otherwise it will not start normally.
...
6.  [translations](translations): Translation file;
...
-   > MacOS, the bundle generated by cmake is not generated in the .app/Contents/ folder`PkgInfo`document;
    ...
    >     1.  Using WireShark`set_source_files_properties(${CMAKE_CURRENT_SOURCE_DIR}/PkgInfo PROPERTIES MACOSX_PACKAGE_LOCATION .)`In a similar way, copy it to the bundle;
...
-   > International real-time translation. After changing the translation settings, you need to restart the program to take effect;
    ...
    2.  Too lazy to change the code;
    3.  [Specific reference: QT practical tips (update as soon as I think of it)](https://realchuan.github.io/2021/10/12/QT%E5%AE%9E%E7%94%A8%E5%B0%8F%E6%8A%80%E5%B7%A7%EF%BC%88%E6%83%B3%E5%88%B0%E5%B0%B1%E6%9B%B4%E6%96%B0%EF%BC%89/), core code;
