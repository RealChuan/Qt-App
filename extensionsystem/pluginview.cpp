...
#include <gui/categorysortfiltermodel.h>
#include <gui/itemviews.h>
...
static const QIcon &icon(IconIndex icon)
{
    ...
    switch (icon) {
    case OkIcon: {
        i.addFile(QLatin1String(":/icon/icon/ok.png"));
        return i;
    }
    case ErrorIcon: {
        i.addFile(QLatin1String(":/icon/icon/broken.png"));
        return i;
    }
    case NotLoadedIcon: {
        i.addFile(QLatin1String(":/icon/icon/notLoad.png"));
        return i;
    }
    }
    return i;
...
class PluginItem : public GUI::TreeItem
{
public:
...
class CollectionItem : public GUI::TreeItem
{
public:
...
PluginView::PluginView(QWidget *parent)
    : QWidget(parent)
{
    m_categoryView = new GUI::TreeView(this);
    ...
    m_categoryView->setActivationMode(GUI::DoubleClickActivation);
    ...
    m_model = new GUI::TreeModel<GUI::TreeItem, CollectionItem, PluginItem>(this);
    m_model->setHeader({Tr::tr("Name"), Tr::tr("Load"), Tr::tr("Version"), Tr::tr("Vendor")});

    m_sortModel = new GUI::CategorySortFilterModel(this);
