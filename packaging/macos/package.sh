...
mv -vf "${packet_dir}/fonts" "${packet_dir}/${app_name}.app/Contents/MacOS/"
...
cd "${packet_dir}"
dmgbuild -s "${project_dir}/packaging/macos/dmgbuild.py" "${app_name}.app" "${app_name}.dmg"
mv -v "${packet_dir}/${app_name}.dmg" "${releases_dir}"
