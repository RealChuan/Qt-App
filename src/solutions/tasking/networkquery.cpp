...
void NetworkQuery::start()
{
    ...
    switch (m_operation) {
    case QNetworkAccessManager::HeadOperation: m_reply.reset(m_manager->head(m_request)); break;
    case QNetworkAccessManager::GetOperation: m_reply.reset(m_manager->get(m_request)); break;
