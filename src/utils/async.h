...
UTILS_EXPORT QThreadPool *asyncThreadPool(QThread::Priority priority);

template<typename Function, typename... Args>
auto asyncRun(QThreadPool *threadPool,
...
{
    return asyncRun<Function, Args...>(nullptr,
                                       priority,
...
{
    return asyncRun<Function, Args...>(threadPool,
...
class UTILS_EXPORT AsyncBase : public QObject
{
    Q_OBJECT
