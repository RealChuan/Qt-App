...
class UTILS_EXPORT ElidingLabel : public QLabel
{
    ...
    Q_PROPERTY(
        QString additionalToolTip READ additionalToolTip WRITE setAdditionalToolTip DESIGNABLE true)
    Q_PROPERTY(QString additionalToolTipSeparator READ additionalToolTipSeparator WRITE
                   setAdditionalToolTipSeparator DESIGNABLE true)
