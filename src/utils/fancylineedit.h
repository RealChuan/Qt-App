...
class UTILS_EXPORT FancyIconButton : public QAbstractButton
{
    Q_OBJECT
...
class UTILS_EXPORT FancyLineEdit : public CompletingLineEdit
{
    Q_OBJECT
public:
    ...
    void setHistoryCompleter(const Utils::Key &historyKey,
                             bool restoreLastItemFromHistory = false,
                             int maxLines = 6);
