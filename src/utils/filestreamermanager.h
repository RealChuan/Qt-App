...
class UTILS_EXPORT FileStreamerManager
{
public:
    static FileStreamHandle copy(const FilePath &source,
    ...
    static FileStreamHandle read(const FilePath &source,
                                 QObject *context,
                                 const ReadContinuation &cont = {});

    static FileStreamHandle write(const FilePath &destination,
