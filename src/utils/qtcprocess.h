...
public:
    ...
    static bool startDetached(const CommandLine &cmd,
    ...
    static QString exitMessage(const CommandLine &command,
...
private:
    friend UTILS_EXPORT QDebug operator<<(QDebug str, const Process &r);
