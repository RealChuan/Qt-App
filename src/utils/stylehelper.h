...
UTILS_EXPORT QPalette sidebarFontPalette(const QPalette &original);
...
UTILS_EXPORT void setBaseColor(const QColor &color);

// Draws a shaded anti-aliased arrow
UTILS_EXPORT void drawArrow(QStyle::PrimitiveElement element,
                            QPainter *painter,
                            const QStyleOption *option);
UTILS_EXPORT void drawMinimalArrow(QStyle::PrimitiveElement element,
                                   QPainter *painter,
                                   const QStyleOption *option);
...
UTILS_EXPORT void drawIconWithShadow(const QIcon &icon,
                                     const QRect &rect,
                                     QPainter *p,
                                     QIcon::Mode iconMode,
